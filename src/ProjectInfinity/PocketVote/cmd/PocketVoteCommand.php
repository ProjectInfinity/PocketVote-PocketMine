...
class PocketVoteCommand extends Command implements PluginIdentifiableCommand {
    ...
    public function execute(CommandSender $sender, $commandLabel, array $args) {
        ...
        if(count($args) === 0) {
            $sender->sendMessage(TextFormat::AQUA.'Specify an action: SECRET, IDENTITY');
            return true;
        }
        switch(strtoupper($args[0])) {
            ...
            case 'CMD':
                ...
                switch(strtoupper($args[1])) {
                    ...
                    case 'ADD':
                        ...
                        $this->plugin->getConfig()->setNested('onvote.run-cmd', $this->plugin->cmds);
            ...
            default:
                $sender->sendMessage(TextFormat::RED.'Invalid option. Specify SECRET, IDENTITY or CMD.');
        }
        return true;
    }
